...
void BallRenderer::renderBall(gengine::SpriteBatch& spriteBatch,
...
void MomentumBallRenderer::renderBall(gengine::SpriteBatch& spriteBatch,
	const std::vector<Ball>& balls,
	const glm::mat4& projectionMatrix) {
...
void VelocityBallRenderer::renderBall(gengine::SpriteBatch& spriteBatch,
	const std::vector<Ball>& balls,
	const glm::mat4& projectionMatrix) {
...
PulsingBallRenderer::PulsingBallRenderer(int screenWidth, int screenHeight) :
			m_screenWidth(screenWidth), m_screenHeight(screenHeight) {
	m_time = 0.0f;
}

void PulsingBallRenderer::renderBall(gengine::SpriteBatch& spriteBatch,
	const std::vector<Ball>& balls,
	const glm::mat4& projectionMatrix) {
	...
	for (auto& ball : balls) {
		...
		glm::vec2 centerScreenPosition(m_screenWidth / 2.0f, m_screenHeight / 2.0f);

		glm::vec2 centerVec = ball.position - centerScreenPosition;
